                ...
                if (isset($result['result'][0])) {
                    ...
                    if (isset($result['result'])) {
                        ...
                        if ($name == $result['result']['NAME'] && $lastname == $result['result']['LAST_NAME']) {
                            ...
                            $this->redirect('handbook/?error=1', 'Предоставленные данные не корректны! Свяжитесь с представителем Вашего сертификата для получения технической консультации', 403, 'Error');
                        }
                    } else {
                        $this->redirect('handbook/?error=1', 'Предоставленные данные не корректны! Свяжитесь с представителем Вашего сертификата для получения технической консультации', 403, 'Error');
                    }
