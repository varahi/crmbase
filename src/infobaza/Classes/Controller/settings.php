<?php
define('C_REST_CLIENT_ID', 'local.62ec09ff112db9.47820369');//Application ID
define('C_REST_CLIENT_SECRET', 'aZPDiiqnNNEbssSz2f6IzkQZFWHaF1h8NX2CrsV4RHo3GYEThD');//Application key
// or
